 ...
 *****************************************************************************
 * @file   proc.c
 * @brief  The file contains main IPC routines.
 * The distance between @f$(x_1,y_1)@f$ and \f$(x_2,y_2)\f$ is \f$\sqrt{(x_2-x_1)ˆ2+(y_2-y_1)ˆ2}\f$.
 * @author Forrest Yu
 * @date   2005
 *****************************************************************************
 *****************************************************************************/
 ...
 *****************************************************************************/
/**
 * <Ring 1~3> Dump a proc table entry into a file.
 * 
 * @param p  The proc to be dumped.
...
PUBLIC void dump_proc(struct proc* p, int fd)
{
	...
	/* exclude `struct proc::filp[NR_FILES]' */
	int dump_len = sizeof(struct proc) -
		sizeof(struct file_desc *) * NR_FILES;

	printl("MM:dump_proc:fd: %d\n", fd);
 ...
 *****************************************************************************/
/**
 * <Ring 1~3> Dump a MESSAGE.
 * 
 * @param title  The string to be printed at the beginning of the output.
 * @param m      The message to be dumped.
 *****************************************************************************/
